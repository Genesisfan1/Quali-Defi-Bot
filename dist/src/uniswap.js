...
function computeExecPrice(amountIn, decIn, amountOut, decOut) {
    try {
...
function symbolFromAddr(addr) {
    const a = addr.toLowerCase();
    if (a === "0xc02aa39b223fe8d0a0e5c4f27ead9083c756cc2")
        return "ETH";
